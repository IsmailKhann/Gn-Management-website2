              ...
              {milestones.map((milestone, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="relative rounded-3xl overflow-hidden shadow-2xl group inline-block w-full">
                        <img
                          src={milestone.image}
                          alt={milestone.title}
                          loading="lazy"
                          className="w-full h-auto max-h-[500px] object-contain transform group-hover:scale-105 transition-transform duration-700 rounded-3xl"
                        />
